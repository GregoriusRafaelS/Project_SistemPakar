    ...
    <div class="row content">
        <div class="col-sm-8 offset-sm-2 text-left"> 
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <?php
                        $tampil_gejala = "SELECT * FROM penyakit p, basispengetahuan b WHERE p.idpenyakit='" . $_GET['id'] . "' AND p.namapenyakit=b.namapenyakit";
                        $sql_gejala = mysqli_query($konek_db, $tampil_gejala);
                        while($data = mysqli_fetch_array($sql_gejala)) {
                            echo "<input type='text' class='form-control mb-2' id='gejala' readonly value='" . $data['gejala'] . "'>";
                        }
                    ?>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <?php
                        $sql = mysqli_query($konek_db, $tampil);
                        while($data = mysqli_fetch_array($sql)) {
                            echo "<textarea rows='8' class='form-control' id='pengendalian' readonly>" . $data['pengendalian'] . "</textarea>";
                        }
                    ?>
                </div>  
            </div>
